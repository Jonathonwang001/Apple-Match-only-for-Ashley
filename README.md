...
(function() {
    ...
    // 添加到游戏界面
    document.getElementById('gameScreen').appendChild(helpButton);
    ...
    const helpContent = `
        <div style="max-width: 600px; padding: 2rem;">
            ...
            <div style="background: rgba(255, 255, 255, 0.9); border-radius: 15px; padding: 1.5rem; margin-bottom: 1.5rem;">
                <h3 style="color: #ff6b6b; margin-bottom: 1rem;">🎮 游戏玩法</h3>
                <ul style="list-style-type: none; padding-left: 0;">
                    <li style="margin-bottom: 0.8rem;">👉 交换相邻苹果，匹配3个或更多相同苹果</li>
                    <li style="margin-bottom: 0.8rem;">👉 达成关卡目标分数即可通关</li>
                    <li style="margin-bottom: 0.8rem;">👉 合理使用道具提高分数</li>
                    <li style="margin-bottom: 0.8rem;">👉 注意剩余步数，合理规划每一步</li>
                </ul>
            </div>
            
            <div style="background: rgba(255, 255, 255, 0.9); border-radius: 15px; padding: 1.5rem; margin-bottom: 1.5rem;">
                <h3 style="color: #ff6b6b; margin-bottom: 1rem;">💎 道具说明</h3>
            ...
            <div style="text-align: center;">
                <button id="closeHelpBtn" style="padding: 0.8rem 2rem; background: #ff6b6b; color: white; 
    ...
    function showGameHelp() {
        ...
        helpOverlay.id = 'gameHelpOverlay';
        ...
        document.getElementById('closeHelpBtn').onclick = function() {
            document.getElementById('gameHelpOverlay').remove();
        };
    }
    
    console.log("游戏内帮助系统已启用！");
})();
</script>
</body>
</html>
